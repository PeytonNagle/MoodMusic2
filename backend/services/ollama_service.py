...
- ONLY output the JSON, no other text"""
    ...
    def _extract_json_with_salvage(self, content: str) -> Any:
        """Parse JSON and attempt repair on failure."""
        try:
    ...
    def _extract_json(self, content: str) -> Any:
        """Normalize and parse JSON content from Ollama responses."""
    ...
    def _salvage_to_last_complete_song(self, content: str) -> str:
        ...
        This handles truncated responses by finding the last complete song entry
        ...
        # Drop trailing comma before closing array
        if text.endswith(','):
            text = text.rstrip(', \n\r\t')

        # Close the songs array and root object if needed
